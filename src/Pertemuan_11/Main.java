...
public class Main {
	   public static void main(String[] args) {
		   ...
		   family.addNiece("Diaz", 23, 2);
		   family.addNiece("Adhari", 1, 10);
		   
		   /*Checking for Duplicate Nieces*/
		   if(family.addNiece("Diaz", 23, 2)) System.out.println("Duplicate input !! ");
		   ...
		   /*Add Present*/
		   uncle.addPresent(family.findNiece("Diaz"), "Lego");
		   family.addNiece("Hanz", 9, 11);
		   
		   /*Checking Present from Uncle*/
		   uncle.addPresent(family.findNiece("Adhari"), "MiniCar");
		   uncle.addPresent(family.findNiece("Hanz"), "MiniCar");
		   
		   /*Checking two Uncle for given the same present*/
		   uncle1.addPresent(family.findNiece("Adhari"), "MiniCar");
		   ...
		   family.listUncles();
		   uncle.listPresents();
		   family.findNiece("Diaz").listPresents();
		   family.findNiece("Adhari").listPresents();
	   }
}
